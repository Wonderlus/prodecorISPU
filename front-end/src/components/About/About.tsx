...
const About = () => {
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Команда PRODECOR HOME это</h1>
            <div className={styles.aboutList}>
				...
				c115.6,5.1,208.7,98.2,213.8,213.8H427c-5.5,0-10,4.5-10,10s4.5,10,10,10h40.8C462.7,909.96,369.6,1003.06,254,1008.16z"
                    ...
                    <h2 className={styles.itemTitle}>Быстрая доставка</h2>
                    {/* <p className={styles.itemText}></p> */}
                </div>
                <div className={styles.aboutItem}>
                    <img src="about/guarantee.png" />
                    <h2 className={styles.itemTitle}>Гарантия</h2>
                    {/* <p className={styles.itemText}></p> */}
                </div>
                <div className={styles.aboutItem}>
                    <img src="about/certificate.png" />
                ...
                <div className={styles.aboutItem}>
                    ...
                    <h2 className={styles.itemTitle}>Дружная команда</h2>
                    {/* <p className={styles.itemText}></p> */}
                </div>
            </div>
        </div>
